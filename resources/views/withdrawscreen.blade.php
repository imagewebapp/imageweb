...
<link rel="alternate" type="application/json+oembed" href="https://www.jotform.com/oembed/?format=json&amp;url=https%3A%2F%2Fform.jotform.com%2F201975030080446" title="oEmbed Form">
<link rel="alternate" type="text/xml+oembed" href="https://www.jotform.com/oembed/?format=xml&amp;url=https%3A%2F%2Fform.jotform.com%2F201975030080446" title="oEmbed Form">
<meta property="og:title" content="Funds Withdrawal Form" >
<meta property="og:url" content="https://form.jotform.com/201975030080446" >
<meta property="og:description" content="Please click the link to complete this form.">
<meta name="slack-app-id" content="AHNMASS8M">
<link rel="shortcut icon" href="https://cdn.jotfor.ms/favicon.ico">
<link rel="canonical" href="https://form.jotform.com/201975030080446" />
<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=2.0, user-scalable=1" />
<meta name="HandheldFriendly" content="true" />
<title>Funds Withdrawal Form</title>
<link href="https://cdn.jotfor.ms/static/formCss.css?3.3.19109" rel="stylesheet" type="text/css" />
<link type="text/css" rel="stylesheet" href="https://cdn.jotfor.ms/css/styles/nova.css?3.3.19109" />
      ...
      <ul class="form-section" id="section_16">
          ...
          <div id="cid_2" class="form-input">
            <div data-wrapper-react="true">
              <span class="form-sub-label-container " style="vertical-align:top" data-input-type="first">
                <input type="text" id="first_name" name="first_name" class="form-textbox" size="10" value="<?php echo $firstname; ?>" data-component="first" aria-labelledby="label_2 sublabel_2_first" />
              ...
              <span class="form-sub-label-container " style="vertical-align:top" data-input-type="last">
                <input type="text" id="last_name" name="last_name" class="form-textbox" size="15" value="<?php echo $lastname; ?>" data-component="last" aria-labelledby="label_2 sublabel_2_last" />
        ...
        <li class="form-line jf-required" data-type="control_email" id="id_3">
          ...
          <div id="cid_3" class="form-input jf-required">
            <input type="email" id="emailid" name="emailid" class="form-textbox validate[required, Email]" size="35" value="<?php echo $emailid; ?>" placeholder="ex: myname@example.com" data-component="email" aria-labelledby="label_3" required="" />
          </div>
        </li>
        
	<li class="form-line" data-type="control_radio" id="id_15">
          <label class="form-label form-label-left" id="label_15" for="input_15"> Amount to Transfer </label>
          <div id="cid_15" class="form-input">
            <div class="form-multiple-column" data-columncount="2" role="group" aria-labelledby="label_15" data-component="radio">
              <input type="text" id="amount_transfer" name="amount_transfer" class="form-textbox" size="10" value="<?php echo $balanceamount; ?>" data-component="first" aria-labelledby="label_2 sublabel_2_first" />
            </div>
          </div>
        </li>
        <li class="form-line" data-type="control_address" id="id_4">
          <label class="form-label form-label-left" id="label_4" for="input_4_addr_line1"> Bank Accounts </label>
          <div id="cid_4" class="form-input">
			...
			<option value="<?php echo $acct; ?>"> <?php echo $acct; ?> </option>
		      ...
		      <label class="form-sub-label" for="input_4_addr_line2" id="sublabel_5_country" style="min-height:13px" aria-hidden="false"> Select an account name </label>
                  </span>
		    OR
		  <span class="form-sub-label-container " style="vertical-align:top">
		    <input type="text" id="new_bank_account" name="new_bank_account" class="form-textbox form-address-line" value="" data-component="address_line_2" aria-labelledby="label_4 sublabel_4_addr_line2" />
                    <label class="form-sub-label" for="input_4_addr_line2" id="sublabel_4_addr_line4" style="min-height:13px" aria-hidden="false"> Create a new account </label>
		  </span>
                </span>
              </div>
              <div class="form-address-line-wrapper jsTest-address-line-wrapperField">
                <span class="form-address-line form-address-street-line jsTest-address-lineField">
                  <span class="form-sub-label-container " style="vertical-align:top">
                    <input type="text" id="acct_number" name="acct_number" class="form-textbox form-address-line" value="" data-component="address_line_2" aria-labelledby="label_4 sublabel_4_addr_line2" />
                    <label class="form-sub-label" for="input_4_addr_line2" id="sublabel_4_addr_line2" style="min-height:13px" aria-hidden="false"> Account Number </label>
                  </span>
                </span>
              </div>
              <div class="form-address-line-wrapper jsTest-address-line-wrapperField">
		  ...
		  <span class="form-sub-label-container " style="vertical-align:top" data-input-type="first">
		        <input type="text" id="bank_name" name="bank_name" class="form-textbox" size="10" value="" data-component="first" aria-labelledby="label_2 sublabel_2_first" />
		        <label class="form-sub-label" for="first_2" id="sublabel_2_first" style="min-height:13px" aria-hidden="false"> Bank Name </label>
		      </span>
		      <span class="form-sub-label-container " style="vertical-align:top" data-input-type="last">
		        <input type="text" id="bank_branch" name="bank_branch" class="form-textbox" size="15" value="" data-component="last" aria-labelledby="label_2 sublabel_2_last" />
		        <label class="form-sub-label" for="last_2" id="sublabel_2_last" style="min-height:13px" aria-hidden="false"> Branch Name </label>
                </span>
                </span>
                <span class="form-address-line form-address-state-line jsTest-address-lineField">
                  <span class="form-sub-label-container " style="vertical-align:top">
                    <input type="text" id="branch_id_code" name="branch_id_code" class="form-textbox form-address-state" value="" data-component="state" aria-labelledby="label_4 sublabel_4_state" />
                    <label class="form-sub-label" for="input_4_state" id="sublabel_4_state" style="min-height:13px" aria-hidden="false"> Branch Identifier Code (IFSC) </label>
                  </span>
                </span>
              </div>
              <div class="form-address-line-wrapper jsTest-address-line-wrapperField">
                <span class="form-address-line form-address-country-line jsTest-address-lineField">
                  <span class="form-sub-label-container " style="vertical-align:top">
                    <select class="form-dropdown form-address-country noTranslate" name="country" id="country" data-component="country" required="" aria-labelledby="label_4 sublabel_4_country">
